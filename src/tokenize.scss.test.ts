...
import { tokenize } from './tokenize.scss.js'
...
describe('Tokenization', () => {
	...
	test('Tokenizing sass variables', () => {
		// sass variables
		expect(Array.from(tokenize(`$a`))).toHaveLength(1)
		expect(Array.from(tokenize(`$ab`))).toHaveLength(1)
		expect(Array.from(tokenize(`$a-b`))).toHaveLength(1)
		expect(Array.from(tokenize(`$ab-`))).toHaveLength(1)
		expect(Array.from(tokenize(`$1`))).toHaveLength(1)
		expect(Array.from(tokenize(`$123`))).toHaveLength(1)
		expect(Array.from(tokenize(`$\\$`))).toHaveLength(1)

		// not quite sass variables
		expect(Array.from(tokenize(`-$a`))).toHaveLength(2)
		expect(Array.from(tokenize(`$$`))).toHaveLength(2)
	})
})
