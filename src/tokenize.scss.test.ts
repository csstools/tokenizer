...
describe('Tokenization', () => {
	...
	test('Tokenizing sass variables', () => {
		// sass variables
		expect(getTokenArray(`$a`)).toHaveLength(1)
		expect(getTokenArray(`$ab`)).toHaveLength(1)
		expect(getTokenArray(`$a-b`)).toHaveLength(1)
		expect(getTokenArray(`$ab-`)).toHaveLength(1)
		expect(getTokenArray(`$1`)).toHaveLength(1)
		expect(getTokenArray(`$123`)).toHaveLength(1)
		expect(getTokenArray(`$\\$`)).toHaveLength(1)
		...
		expect(getTokenArray(`-$a`)).toHaveLength(2)
		expect(getTokenArray(`$$`)).toHaveLength(2)
	})
})
